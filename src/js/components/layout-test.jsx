...
render: function() {
  return (
      ...
      this.state.data.map(function(val,idx){
        return(
          <tr row-index={MusicInfo.trackIndex} style="position: relative; padding-top: 40px;" id="wlistLinklist1_1" class="">
            ...
            <td id="wlistLinklist1_1_1" class="colThree" title="unknown artist">{MusicInfo.artist}</td>
            <td id="wlistLinklist1_1_commands" class="colFour" title="unknown album">{MusicInfo.album}</td>
...
if(jQuery) {
    ...
    self._heading = ReactDOM.render(heading, document.getElementById('SyncTabView'));

    self._textarea =  ReactDOM.render(React.createElement(textArea,{ text: "bigkevzs" }),document.getElementById("SyncTabView"));
