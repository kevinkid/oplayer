...
var handlers = {
    ...
    onWindowResize: function (ev) {
        // NOTE: called twice when window is maximized .
    ...
    /** @description range volume value to audio range value */
    ...
    /** @description checks if the selected track index is not the same as the current active index */
    ...
    /**
     * @description Sets listeners for all the elements
     */
