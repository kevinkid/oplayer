...
/** 
 * @description "play next" context menu
 */
...
/**
 * @description set next track on context menu click event
 */
function setNextTrack() {}

/** 
 * @description show the next log
 */
...
/**
 * @description keeps the application useble incase of errors .
 */
...
/**
 * @description  App information logging
...
/**
 * @description log important application activity
 */
...
/**
 * @description Basic app configurations
 */
app.setup = function () {
